      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white dark:bg-slate-800/90 rounded-2xl border border-gray-200 dark:border-slate-700 shadow-2xl p-8 backdrop-blur-sm animate-slide-up">
          ...
          <div className="space-y-3">
            ...
            <button
              type="button"
              onClick={() => !providersStatus.google ? null : handleOAuthSignIn('google')}
              disabled={oauthLoading !== null || !providersStatus.google}
              title={!providersStatus.google ? 'Google OAuth not configured - coming soon' : 'Sign in with Google'}
              className={`w-full py-3 px-4 rounded-xl font-medium transition-all duration-200 flex items-center justify-center gap-3 ${
                !providersStatus.google
                  ? 'bg-gray-100 dark:bg-slate-700/50 border-2 border-gray-300 dark:border-slate-600 text-gray-400 dark:text-slate-500 cursor-not-allowed'
                  : 'bg-white dark:bg-slate-700 border-2 border-gray-300 dark:border-slate-600 text-gray-900 dark:text-white hover:bg-gray-50 dark:hover:bg-slate-600'
              }`}
            >
              {oauthLoading === 'google' ? (
            ...
            <button
              type="button"
              onClick={() => !providersStatus.github ? null : handleOAuthSignIn('github')}
              disabled={oauthLoading !== null || !providersStatus.github}
              title={!providersStatus.github ? 'GitHub OAuth not configured - coming soon' : 'Sign in with GitHub'}
              className={`w-full py-3 px-4 rounded-xl font-medium transition-all duration-200 flex items-center justify-center gap-3 ${
